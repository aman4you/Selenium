...
public class PressRelease extends HCLAbstract {
    ...
    public static Collection testData() {
        return Arrays.asList(
                new Object[][]{
                        {"dummy", "Today", "Abstract", "shortDesc", "Desc", FilesPath + "bc.pdf", "metaDesc", "metaKey", "all inputs are correct", "Admin"}
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public PressRelease(String Title, String Date, String Abstract, String ShortDescription, String Description, String PDF, String MetatagDescription, String MetatagKeyword, String TestCase, String Role) {
        this.Title = Title;
        this.Date = Date;
