...
public class PrintAndOnline extends HCLAbstract {
    ...
    public static Collection testData() {
        return Arrays.asList(
                new Object[][]{
                        {"title", "Today", "Desc", "source", FilesPath + "bc.pdf", "linkTitle", "https://www.google.co.in", FilesPath + "abc.jpg", "Alt", "PicTitle", "TransTitle", "https://www.google.co.in", "MetaDesc", "MetaKey", "All inputs are correct", "Admin"}
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public PrintAndOnline(String Title, String PublishedDate, String Description, String Source, String PDF, String LinkTitle, String LinkUrl, String Thumbnail, String AlternateText, String PictureTitle, String TranscriptTitle, String TranscriptUrl, String MetatagDescription, String MetatagKeyword, String TestCase, String Role) {
        this.Title = Title;
