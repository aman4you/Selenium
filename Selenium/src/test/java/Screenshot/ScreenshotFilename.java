/**
 * To get screenshot filename from url:-
 * 1. Url should have text after base url.
 * 2. Filename column should have any text.
 */
...
public class ScreenshotFilename {
    private static String BaseUrlReplaceWith = "http://www.hcltech.com";
    private static String BaseUrlToBeReplaced = "http://www.hcltech.com";
    private static String SheetName = "Sheet1";
    private static String ExcelFilePath = "C:\\Users\\aman\\Downloads\\urlList.xlsx";
