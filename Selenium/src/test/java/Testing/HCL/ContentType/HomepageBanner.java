...
public class HomepageBanner extends HCLAbstract {
    ...
    public static Collection testData() {
        return Arrays.asList(
                new Object[][]{
                        {"title", "body", FilesPath + "abc.jpg", "LinkTitle", "https://www.google.co.in", "metaDesc", "metaKey", "all inputs are correct", "Admin"}
...
//                        {"Tomorrow", "160", "45", "When date of future"}
    ...
    public HomepageBanner(String Title, String Body, String BannerImage, String BannerLinkTitle, String BannerLinkUrl, String MetatagDescription, String MetatagKeyword, String TestCase, String Role) {
        this.Title = Title;
        this.Body = Body;
